...
# Entrada: 14:30 ,  02:59 , 25:00 , 74:25, 13:26,  13:36, 13:66, 09:26,22:51
# lookbehind i lookahead regex (?<=^|\s) ... (?=$|\s)

import re

patro = re.compile(r"(?:[01]?\d|2[0-3]):[0-5]\d")

entrada = input("Ingresa un texto con horarios: ")

resultado = patro.findall(entrada)

print("Horarios válidos:", resultado)
